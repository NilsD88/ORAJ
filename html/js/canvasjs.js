...
(function () {
	...
	function Chart(containerId, options) {
		...
		if (this._options.height)
			...
			height = this._container.clientWidth > 0 ? this._container.clientWidth : this.width;
		...
		addEvent(window, "resize", function () {
			...
			if (that._options.height)
				...
				that.height = height = that._container.clientWidth > 0 ? that._container.clientWidth : that.width;
